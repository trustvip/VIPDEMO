...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderMain" runat="Server">
	...
	//Shashanks Changes - START
	console.log(parent.location.href);
	if(parent.location.href != "https://aca.vipconsulting.com/CitizenAccessVIPDEMO/default.aspx")
	{
		var w = window.open("https://aca.vipconsulting.com/CitizenAccessVIPDEMO/default.aspx","_parent");
		w.location.href='https://aca.vipconsulting.com/CitizenAccessVIPDEMO/default.aspx';
	}
	//Shashanks Changes - END
        ...
        <div id="divContainer">
            ...
            <div id="divContent" runat="server">
                ...
                <div id="divDependentCapTypeSetting" visible="false" runat="server">
                    <div class="Header_h4">
                        <ACA:AccelaLabel ID="lblDependentCapType" LabelKey="aca_label_receiptpage_dependentcaptype" runat="server" />
                    </div>
                </div>
                ...
                <div id="divRenewalLicenseInstructions" runat="server" visible="false">
                    <div id="divRenewalAutoIssuanceInstruction" runat="server" visible="false">
                        <div class="ACA_Page ACA_Page_FontSize">
                            <br />
                            <ACA:AccelaLabel ID="per_licenseAutoIssuance_text_instruction" runat="server" LabelKey="per_renewalLicensePermit_text_autoIssuanceInfo" LabelType="BodyText" />
                        </div>
                    </div>
                    <div id="divRenewalNoAutoIssuanceInstruction" runat="server" visible="false">
                        <div class="ACA_Page ACA_Page_FontSize">
                            <br />
                            <ACA:AccelaLabel ID="per_licenseNoAutoIssuance_text_instruction" runat="server" LabelKey="per_renewalLicensePermit_text_noAutoIssuanceInfo" LabelType="BodyText" />
                        </div>
                    </div>
                    <div id="divRenewalDeferredPaymentInstruction" runat="server" visible="false">
                        <div class="ACA_Page ACA_Page_FontSize">
                            <br />
                            <ACA:AccelaLabel ID="per_licenseDeferredPayment_text_instruction" runat="server" LabelKey="per_renewallicenseissuance_text_deferredpaymentbodyinfo" LabelType="BodyText" />
                        </div>
                    </div>
                </div>
