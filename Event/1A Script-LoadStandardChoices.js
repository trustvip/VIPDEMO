...
scValArray.push(['SOLUTION_MAPPING','PublicWorks/*/*/*','PUBLICWORKS']);
...
scValArray.push(['DEPARTMENT_INFORMATION','PublicWorks Department','$$DepartmentAddress$$: 855 Argan Ave.|$$DepartmentCity$$:Salt Lake City|$$DepartmentState$$:UT|$$DepartmentContactPhone$$:999-779-1111|$$DepartmentContactEmail$$:publicworks@ut.com']);
...
scValArray.push(['RPT_CONFIG','PublicWorks Department Name','Department of PublicWorks']);
scValArray.push(['RPT_CONFIG','PublicWorks Department Address','114 Aurora Ave., San Ramon, CA 94533']);
scValArray.push(['RPT_CONFIG','PublicWorks Department Phone','']);
scValArray.push(['RPT_CONFIG','PublicWorks Department Website','']);
scValArray.push(['RPT_CONFIG','PublicWorks Department Director','']);
